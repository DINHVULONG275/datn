...
let modul_tayquay,giac_hut,xilanh_day,Phoi_cao_Mau_do_day, Phoi_cao_Mau_do_quay,Tram_tong
...
async function init() {
    ...
    light5.position.set(0,500,1000)
    scene.add(light5)
    ...
    await Promise.all([
        await loader.load('render3D/3D_Tram1/Lap_ghep_he_thong.glb', function (glb) {
            // ///////////////////////////////////////////////////////////////////////////////////////
            // ///////////////////////////////////////////////////////////////////////////////////////
            ...
            // ///////////////////////////////////////////////////////////////////////////////////////
            // tỉ lệ
            Tram_tong = glb.scene // gán thuộc tính cảnh của đối tượng cho biến
            Tram_tong.scale.set(1, 1, 1);
            // vị trí vật
            Tram_tong.position.x = 0;
            Tram_tong.position.y = 0;
            Tram_tong.position.z = 0;
            Tram_tong.rotation.x = -Math.PI / 2;
            scene.add(Tram_tong); // thêm vào màn hình
            done_load_3D = true;
        }),
