...
async function init() {
    ...
    await Promise.all([
        await loader.load('render3D/3D_tram4/Tram_tay_gap.glb', function (glb) {
            ...
            // vị trí vật
            Tram_cap_phoi_thieu.position.x = 0.2;
            Tram_cap_phoi_thieu.position.y = 0.4;
            Tram_cap_phoi_thieu.position.z = 0;
            scene.add(Tram_cap_phoi_thieu); // thêm vào màn hình
            done_load_3D = true;
        }),
        // await loader.load('render3D/3D_tram4/xilanh_day.glb', function (glb) {
        ...
        // }),
        // await loader.load('render3D/3D_tram4/modul_tayquay.glb', async function (glb) {
        ...
        //     await loader.load('render3D/3D_tram4/tay_quay_giac_hut.glb', async function (glb) {
        //         giac_hut = glb.scene;
        //         // tỉ lệ
